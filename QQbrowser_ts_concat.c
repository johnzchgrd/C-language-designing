/** \file temp.c
  ...
  */
#include<stdio.h>
#define TSNUM 854 //ts片段数量
#define DELTA 80//可以用质因数分解方法找到合适的值，数量不宜过多
#define ENDNUM (TSNUM/DELTA*DELTA)
#define LASTFEW (TSNUM-ENDNUM)

#define TRY 0//合成MP4时不同选项（尚未了解）
